/***************************************************************************//**
* @file     main.c
* @brief    An example of TS(Temperature Sensor) using polling mode on A31G22x
...
static void Main_MainLoop(void)
{
	...
	TS_Config.MatchInterrupt = DISABLE;
	TS_Config.ReferencePeriod = 32000; // 32000 / 32Mhz = 1ms
	TS_Init(&TS_Config);
