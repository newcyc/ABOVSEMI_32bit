/***************************************************************************//**
* @file     main.c
* @brief    An example of GPIO output(LED Blinky) on A31G22x
...
*******************************************************************************/
static void Main_Delay(uint32_t ms);
...
static void Main_MainLoop(void)
{
	...
	// Test Pin setting (PE0 / PE1 / PE2 / PE3 / PE4 / PE5)
	...
	PCU_ConfigureDirection(PE, 3, PCU_MODE_PUSH_PULL);
	PCU_ConfigurePullupdown(PE, 3, PCU_PUPD_DISABLE);	
	GPIO_SetValue(PE, _BIT(3));

	PCU_ConfigureDirection(PE, 4, PCU_MODE_PUSH_PULL);
	PCU_ConfigurePullupdown(PE, 4, PCU_PUPD_DISABLE);
	GPIO_SetValue(PE, _BIT(4));

	PCU_ConfigureDirection(PE, 5, PCU_MODE_PUSH_PULL);
