...
void TIMER2_Handler(void)
{
	...
	status = T2->CON;
	T2->CON = (status|TnCON_IFLAG_MASK);
...
void I2C0_Handler (void)
{
	...
	//----------------------------------------------------------------------------------
	// TEST #1, #2, #5, #6, #7, #8, #9, #10, #11
	//----------------------------------------------------------------------------------
	I2C0_Master_Transmit_Receive_ISR(); 
//	I2C0_Master_Transmit_Receive_ISR2(); 	// ioexpander (RESTART supported)

	//----------------------------------------------------------------------------------
	// TEST #3, #4
	//----------------------------------------------------------------------------------	
//	I2C0_Slave_Transmit_Receive_ISR(); 
...
void I2C1_Handler (void)
{
	...
	// TEST #3, #4
	//----------------------------------------------------------------------------------
//	I2C1_Master_Transmit_Receive_ISR(); 


	//----------------------------------------------------------------------------------
	// TEST #1, #2, #5, #6, #7, #8, #9', 
	//----------------------------------------------------------------------------------	
	I2C1_Slave_Transmit_Receive_ISR(); 
//	I2C1_Master_Transmit_Receive_ISR2(); 		// I2C1=master, support RESTART 
