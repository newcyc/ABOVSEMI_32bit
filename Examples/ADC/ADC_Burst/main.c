...
static TIMER_PERIODICCFG_Type TIMER1_Config;	
static const uint8_t menu[] =
"************************************************\n\r"
"\t - MCU: A34M41x \n\r"
"\t - Core: ARM Cortex-M4F \n\r"
"\t - Communicate via: UART0 - 38400 bps \n\r"
"\t Using ADC in burst mode \n\r"
"************************************************\n\r";
static __IO uint32_t fflag;
...
{	
	...
	HAL_ADC_TriggerlSel(ADC0, 0x00000001); //trigger timer1
	HAL_ADC_ChannelSel_1(ADC0, 0x06040200);	//ch0, ch2, ch4, ch6
