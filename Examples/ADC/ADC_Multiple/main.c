...
"\t - Using ADC burst(interrupt) mode\r\n"
"************************************************\r\n";
...
{
	if (TIMER1n_GetStatus(TIMER12) & TIMER1n_STATUS_MATCH_INT) {
		TIMER1n_ClearStatus(TIMER12, TIMER1n_STATUS_MATCH_INT);
	}
}
...
static void Main_InitializeTimer1n(void)
{
	...
	TIMER1n_Init(TIMER11, &TIMER1n_Config);
	TIMER1n_Init(TIMER12, &TIMER1n_Config);
...
static void Main_MainLoop(void)
{
	...
	ADC_Config.Mode = ADC_MODE_BURST;
	...
	Data[1] = ADC_TRIGGER_SOURCE_2;
	Data[2] = ADC_TRIGGER_SOURCE_1;
	Data[3] = ADC_TRIGGER_SOURCE_15;
