...
void USART12_13_SPI21_IRQHandler(void)
{
	...
	/* Determine the UST12 interrupt source */
    ...
    /* Determine the UST13 interrupt source */
...
void mainloop(void)
{
	...
	USART_IntConfig((USART_Type *)USART10, USART_INTCFG_RXC, ENABLE);
	USART_IntConfig((USART_Type *)USART10, USART_INTCFG_TXC, ENABLE);
    ...
    /* Enable USART interrupt */
    USART_IntConfig((USART_Type *)USART11, USART_INTCFG_RXC, ENABLE);
	USART_IntConfig((USART_Type *)USART11, USART_INTCFG_TXC, ENABLE);
    ...
    /* Enable USART interrupt */
    USART_IntConfig((USART_Type *)USART12, USART_INTCFG_RXC, ENABLE);
	USART_IntConfig((USART_Type *)USART12, USART_INTCFG_TXC, ENABLE);
    ...
    /* Enable USART interrupt */
    USART_IntConfig((USART_Type *)USART13, USART_INTCFG_RXC, ENABLE);
	USART_IntConfig((USART_Type *)USART13, USART_INTCFG_TXC, ENABLE);
