/***************************************************************************//**
* @file     main.c
* @brief    An example of USRT using USART polling mode on A31G22x
...
void mainloop(void)
{
	USART_CFG_Type USARTConfigStruct;
   	...
   	// default: 38400-8-N-1	
	USART_USRT_Mode_ConfigStructInit(&USARTConfigStruct);	
    ...
    USART_DataControlConfig(USART10, USART_CONTROL_DISSCK, ENABLE);
	#endif
    ...
    USART_DataControlConfig(USART11, USART_CONTROL_DISSCK, ENABLE);
	#endif
    ...
    USART_DataControlConfig(USART12, USART_CONTROL_DISSCK, ENABLE);
	#endif
    ...
    USART_DataControlConfig(USART13, USART_CONTROL_DISSCK, ENABLE);
	#endif
	
   	_DBG_(">> USART USRT TEST.............. ");
