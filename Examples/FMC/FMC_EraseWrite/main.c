/***************************************************************************//**
* @file     main.c
* @brief    An example of Flash erase/write on A31G22x
...
void	tt_flash_iap_pgm(void)
{
	...
	__disable_irq();
	ProgramPage(0,0xFE00,512, fbuffer);
	ProgramPage(0,0x10000,512, fbuffer);	
	ProgramPage(0,0x10200,512, fbuffer);	
	ProgramPage(0,0x10400,512, fbuffer);	
	ProgramPage(0,0x10600,512, fbuffer);	
	ProgramPage(0,0x10E00,512, fbuffer);
	ProgramPage(0,0x11000,512, fbuffer);
	
	ProgramPage(1,0x3F000000,512, fbuffer);
	ProgramPage(1,0x3F000200,512, fbuffer);
	ProgramPage(1,0x3F000400,512, fbuffer);	
	__enable_irq();
}
...
void	tt_flash_iap_erase(void)
{
	...
	EraseSector(0, 0xFE00);
//	EraseSector1k(0, 0xFC00);
//	EraseSector1k(0, 0x10000);	
	GPIO_SetValue(PE,_BIT(0));
	
//	EraseSector4k(0, 0xF000);	
//	EraseSector4k(0, 0x10000);
//	EraseSector4k(0, 0x11000);	
//	EraseSector(1,0x3F000000);	
//	EraseSector(1,0x3F000200);	
//	EraseSector(1,0x3F000400);	
	__enable_irq();
}
...
//	CFMC->MR = 0x66;
//	CFMC->MR = 0x99;
//	CFMC->LOCK = 0x00000000;	// flash read protection on
//	CFMC->MR = 0x00;
//	CFMC->MR = 0x00;
