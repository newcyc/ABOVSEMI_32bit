...
{		
	...
	_DBG("Press PB2 pin to VDD enter sleep mode!\n\r");
	while((HAL_GPIO_ReadPin(PB) & (1UL<<2)) != (1UL<<2));
	
	_DBG("Enter Sleep...Connect PB1 pin to VDD to exit sleep mode!  ");
