/***************************************************************************//**
* @file     main.c
* @brief    An example of 16-bit timer1n using one-shot mode on A31G22x
...
* Private Typedef
*******************************************************************************/
// Timer1n one-short demo configuration structure definition
typedef struct {
	// base address
...
"\t - Using timer1n one-shot mode\r\n"
"************************************************\r\n";

static const TIMER1n_ONESHORT_Type TIMER1n_ONESHORT_CFG[TIMER1n_IP_INDEX_MAX] = {
	{TIMER10,              PE,  6, PCU_ALT_FUNCTION_1},
	{TIMER11,              PE,  7, PCU_ALT_FUNCTION_1},
	{TIMER12,              PA,  5, PCU_ALT_FUNCTION_1},
	{TIMER13, (PORT_Type *)PF, 10, PCU_ALT_FUNCTION_1},
	{TIMER14, (PORT_Type *)PF, 11, PCU_ALT_FUNCTION_1},
	{TIMER15,              PB,  8, PCU_ALT_FUNCTION_1},
	{TIMER16,              PB,  9, PCU_ALT_FUNCTION_1}
};
...
static void Main_MainLoop(void)
{
	const TIMER1n_ONESHORT_Type * pConfig;

	pConfig = &(TIMER1n_ONESHORT_CFG[TARGET_TIMER]);
	...
	TIMER1n_Config.Mode = TIMER1n_MODE_ONESHOT;
