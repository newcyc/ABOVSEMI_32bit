/***************************************************************************//**
* @file     main.c
* @brief    An example of 16-bit timer1n using match(polling) mode on A31G22x
...
static void Main_MainLoop(void)
{
	...
	while (1) {
		while ((TIMER1n_GetStatus(pConfig->pTIMER1x) & TIMER1n_STATUS_MATCH_INT) == 0);
		TIMER1n_ClearStatus(pConfig->pTIMER1x, TIMER1n_STATUS_MATCH_INT);
