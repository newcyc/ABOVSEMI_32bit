/***************************************************************************//**
* @file     main.c
* @brief    An example of 16bit timer1n using PWM mode on A31G22x
...
"\t - Using timer1n PWM mode\r\n"
"************************************************\r\n";

static const TIMER1n_PWM_Type TIMER1n_PWM_CFG[TIMER1n_IP_INDEX_MAX] = {
	{TIMER10, TIMER10_IRQn,              PE,  6, PCU_ALT_FUNCTION_1},
	{TIMER11, TIMER11_IRQn,              PE,  7, PCU_ALT_FUNCTION_1},
	{TIMER12, TIMER12_IRQn,              PA,  5, PCU_ALT_FUNCTION_1},
	{TIMER13, TIMER13_IRQn, (PORT_Type *)PF, 10, PCU_ALT_FUNCTION_1},
	{TIMER14, TIMER14_IRQn, (PORT_Type *)PF, 11, PCU_ALT_FUNCTION_1},
	{TIMER15, TIMER15_IRQn,              PB,  8, PCU_ALT_FUNCTION_1},
	{TIMER16, TIMER16_IRQn,              PB,  9, PCU_ALT_FUNCTION_1}
};
...
static void Main_MainLoop(void)
{
	...
	pConfig = &(TIMER1n_PWM_CFG[TARGET_TIMER]);
	...
	TIMER1n_Config.Mode = TIMER1n_MODE_PWM;
	...
	TIMER1n_Config.AData = 1000; // 1ms

	TIMER1n_Config.BData = 300; // 0.3ms
