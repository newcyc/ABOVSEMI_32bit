...
void PWM1_Handler (void)
{
	...
	PWM_Type			* pwm_obj = PWM1; 
	volatile uint32_t		reg_val; 


	reg_val = pwm_obj->CTRL; 
	pwm_obj->CTRL = reg_val;
	g_PWM1_mon = pwm_obj->CTRL;
...
void PWM2_Handler (void)
{
	...
	PWM_Type			* pwm_obj = PWM2; 
	volatile uint32_t		reg_val; 


	reg_val = pwm_obj->CTRL; 
	pwm_obj->CTRL = reg_val;
	g_PWM2_mon = pwm_obj->CTRL;
...
void PWM3_Handler (void)
{
	...
	PWM_Type			* pwm_obj = PWM3; 
	volatile uint32_t		reg_val; 


	reg_val = pwm_obj->CTRL; 
	pwm_obj->CTRL = reg_val;
	g_PWM3_mon = pwm_obj->CTRL;
...
void PWM4_Handler (void)
{
	...
	PWM_Type			* pwm_obj = PWM4; 
	volatile uint32_t		reg_val; 


	reg_val = pwm_obj->CTRL; 
	pwm_obj->CTRL = reg_val;
	g_PWM4_mon = pwm_obj->CTRL;
...
void PWM5_Handler (void)
{
	...
	PWM_Type			* pwm_obj = PWM5; 
	volatile uint32_t		reg_val; 


	reg_val = pwm_obj->CTRL; 
	pwm_obj->CTRL = reg_val;
	g_PWM5_mon = pwm_obj->CTRL;
...
void PWM6_Handler (void)
{
	...
	PWM_Type			* pwm_obj = PWM6; 
	volatile uint32_t		reg_val; 


	reg_val = pwm_obj->CTRL; 
	pwm_obj->CTRL = reg_val;
	g_PWM6_mon = pwm_obj->CTRL;
...
void PWM7_Handler (void)
{
	...
	PWM_Type			* pwm_obj = PWM7; 
	volatile uint32_t		reg_val; 


	reg_val = pwm_obj->CTRL; 
	pwm_obj->CTRL = reg_val;
	g_PWM7_mon = pwm_obj->CTRL;
