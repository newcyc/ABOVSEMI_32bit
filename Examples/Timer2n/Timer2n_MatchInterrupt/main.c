/***************************************************************************//**
* @file     main.c
* @brief    An example of 32-bit timer2n using match(interrupt) mode on A31G22x
...
#define TARGET_TIMER				(TIMER2n_IP_INDEX_TIMER20) // TIMER2n_IP_INDEX_TIMER20 ~ TIMER2n_IP_INDEX_TIMER21
...
"\t - Using timer2n match(interrupt) mode\r\n"
"************************************************\r\n";
