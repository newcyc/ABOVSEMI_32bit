/***************************************************************************//**
* @file     main.c
* @brief    An example of 32-bit timer2n using one-short mode on A31G22x
...
* Private Typedef
*******************************************************************************/
// Timer2n one-short demo configuration structure definition
typedef struct {
	// base address
...
"\t - Using timer2n one-shot mode\r\n"
"************************************************\r\n";

static const TIMER2n_ONESHORT_Type TIMER2n_ONESHORT_CFG[TIMER2n_IP_INDEX_MAX] = {
	{TIMER20, PC, 0, PCU_ALT_FUNCTION_1, PC, 2, PCU_ALT_FUNCTION_1},
	{TIMER21, PC, 1, PCU_ALT_FUNCTION_1, PC, 3, PCU_ALT_FUNCTION_1}
};
...
static void Main_MainLoop(void)
{
	const TIMER2n_ONESHORT_Type * pConfig;

	pConfig = &(TIMER2n_ONESHORT_CFG[TARGET_TIMER]);
	...
	TIMER2n_Config.Mode = TIMER2n_MODE_ONESHOT;
	...
	TIMER2n_Init(TIMER20, &TIMER2n_Config);
